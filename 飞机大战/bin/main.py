...
from src.plane import *  # 导入我们的飞机
from src.enemy import *
from src.bullet import *

bg_size = 480, 820  # 初始化游戏背景大小(宽, 高)
...
def main():
    ...
    # 标志是否暂停游戏
    paused = False
    pause_nor_image = pygame.image.load("material/image/game_pause_nor.png").convert_alpha()
    pause_pressed_image = pygame.image.load("material/image/game_pause_pressed.png").convert_alpha()
    resume_nor_image = pygame.image.load("material/image/game_resume_nor.png").convert_alpha()
    resume_pressed_image = pygame.image.load("material/image/game_resume_pressed.png").convert_alpha()
    paused_rect = pause_nor_image.get_rect()
    paused_rect.left, paused_rect.top = paused_rect.width - paused_rect.width - 10, 10
